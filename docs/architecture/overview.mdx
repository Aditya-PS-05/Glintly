...
description: 'High-level architecture of the Glintly system'
---

## System Architecture

Glintly is built as a modern, scalable web application with a clear separation of concerns. The architecture consists of multiple layers that work together to provide a seamless AI-powered code generation experience.
